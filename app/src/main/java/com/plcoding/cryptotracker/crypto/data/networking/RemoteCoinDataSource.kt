...
class RemoteCoinDataSource(
    ...
    override suspend fun getCoins(): Result<List<Coin>, NetworkError> {
        return safeCall<CoinsResponseDto> {
            httpClient.get(
                urlString = constructUrl("/assets?apiKey=fbabfd2ef239d6b2c0b595747b156534db75319bb15394a7fa901227ee3e840c")
            )
        }.map { response ->
    ...
    override suspend fun getCoinHistory(
      ...
      return safeCall<CoinsHistoryDto>{ //url string for .get
          httpClient.get(
